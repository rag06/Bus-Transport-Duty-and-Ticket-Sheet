<?php foreach($result['result'] as $resultRow) { ?>
	<br/>
									...
									<tr class="">
										...
										<td style="border: 1px solid black;">
										  <label for="">Collected Amount : </label><?php echo $resultRow['cashdeposit_slip_CollectedAmount']; ?>
										</td>
									</tr>
									</table>
									...
									<table  cellpadding="10" border="1px" style="width:100%;border:1px solid; border-collapse: collapse;margin:20px;">
											...
											?>
												...
												<tr>
													...
													<th style="border: 1px solid black;" >Rs. <span id="lbl-extraAmount"><?php echo $resultRow['cashdeposit_slip_ExtraAmount']; ?></span>
												...
												<tr>
													...
													<th style="border: 1px solid black;" >Rs. <span id="lbl-shotAmount"><?php echo $resultRow['cashdeposit_slip_ShotAmount']; ?></span>
													</th>
												</tr>
									</table>
									<pagebreak>
