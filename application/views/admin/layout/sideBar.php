        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url()?>admin/dailySlip/dailySlip/addDailySlip">Create a Daily Slip</a></li>
                <li><a href="<?php echo base_url()?>admin/dailySlip/dailySlip/index">Manage Daily Slip</a></li>
              </ul>
            </li>
			<li class="treeview">
