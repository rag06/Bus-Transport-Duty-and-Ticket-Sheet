	...
	<?php $this->load->view('admin/layout/sideBar.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Admin Users
            <small>Manage Your Admin Users</small>
          </h1>
          <ol class="breadcrumb">
							...
							<table id="webpagesList" class="table table-bordered table-hover">
								...
								$i=1;
									...
									<tr>
									  ...
									  <td><?php if($row->Admin_Role==1)echo'Admin';else echo'General';?></td>
									  <td>
										<a href="<?php echo base_url() ;?>/admin/admin/users/editAdminUser/<?php echo $row->Admin_Id;?>" class="btn  btn-info btn-sm" >Edit</a>
										
										<button onclick="deleteAdmin(<?php echo $row->Admin_Id;?>)" class="btn  btn-danger btn-sm">Delete</button>
									  </td>
									</tr>
										<?php $i++;}?>
								</tbody>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
					...
					<form action="<?php echo base_url() ;?>/admin/admin/users/deleteUser" method="post">
